    ...
    <div class="avatar-image">
        ...
        <div class="user-comment-star">
            <div class="comment-count" >
                <span>{{ $user_comment_count[$comment->id] }} post</span>
            </div>
        ...
        <div class="media-heading">
            <div class="left">
                ...
                @if(\Illuminate\Support\Facades\Auth::check())
    	            ...
    	            @endif
                @endif
                <span data-created="{{ $comment->created_at }}"> {{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $comment->created_at)->diffForHumans() }}</span>
            </div>
            <div class="right">
                @if ($comment->votes  != '0')
            	<b>

<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <!-- news -->
      <li class="treeview @if(Route::current()->uri=='moderator/news/') active @endif">
        <a href="#">
        ...
        <ul class="treeview-menu">
          <li><a href="{{ secure_url('moderator/news/createNews') }}"><i class="fa fa-circle-o"></i>Create News</a></li>
          <li><a href="{{ secure_url('moderator/news') }}"><i class="fa fa-circle-o"></i>News list</a></li>
        </ul>
      </li>

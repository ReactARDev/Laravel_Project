      ...
      <table class="table table-hover table-bordered table-responsive">
        ...
        @foreach($allChannels as $channel)
          <tr>
            ...
            <td>
              <a href="javascript:void(0);" class="btn btn-danger" onclick="deleteChannel(this);" data-href="{{ secure_url('moderator/channel/delete/'.$channel->channel_id) }}">Delete</a>
            </td>
          </tr>
        @endforeach
        </tbody>

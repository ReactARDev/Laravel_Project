...
Route::group(['prefix' => 'moderator', 'middleware' => ['auth', 'moderator']], function () {
  ...
  Route::get('/admin/dashboard', 'Admin\ModeratorController@dashboard');
  ...
  Route::group(['prefix' => 'news'], function () {
    ...
    Route::post('/storeNews', 'Admin\NewsController@storeNews');
    Route::post('/updateNewsDate/{newslId}', 'Admin\NewsController@updateNewsDate');
    Route::post('/delete/{newslId}', 'Admin\NewsController@delete');
  });

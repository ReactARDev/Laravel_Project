  ...
  public function search($type, $query = "")
  {
    ...
    if ($type === "team") {
      ...
      foreach ($teams as $team) {
        $result[] = array('name' => $team->team_name, 'value' => $team->team_id, 'text' => $team->team_name);
      }
    } else {
      ...
      foreach ($competitions as $competition) {
        $result[] = array('name' => $competition->competition_name, 'value' => $competition->competition_id, 'text' => $competition->competition_name);
      }
    }
